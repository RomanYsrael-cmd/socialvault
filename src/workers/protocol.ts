...
export type ImportRequest = { action: 'inspect' | 'import' | 'verify' | 'cancel'; file?: File; files?: File[]; expectedParts?: import('../archive/schemas/models').ArchivePart[]; sessionId?: string; completedPartIds?: string[]; skippedPartIds?: string[] } | { action: 'part-ack'; ackId: string; ok?: boolean; error?: string };
