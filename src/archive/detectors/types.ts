...
export interface DetectionResult{supported:boolean;platform:ArchivePlatform;confidence:number;entryCount:number;inspectedEntries:number;sections:string[];warnings:string[]}
